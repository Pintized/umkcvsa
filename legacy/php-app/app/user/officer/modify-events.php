...
function fmt_time(?string $t): string { return $t !== null && $t !== '' ? date('g:i A', strtotime($t)) : ''; }
...
<title>Event Management | UMKC VSA</title>
...
<style>
  ...
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  html.dark-mode .work-topbar { background:rgba(17,31,46,.76); }
  ...
  @media (max-width:720px) {
    ...
    .work-topbar { align-items:stretch; flex-direction:column; padding:16px; }
